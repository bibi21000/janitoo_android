...
import org.janitoo.paho.android.service.sample.Connection.ConnectionStatus;
...
//    cause.printStackTrace();
    if (cause != null) {
      ...
      intent.setClassName(context, "org.janitoo.paho.android.service.sample.ConnectionDetails");
  ...
  public void messageArrived(String topic, MqttMessage message) throws Exception {
    ...
    if (topic.startsWith("/values/user")) {
      c.addValueUser(new String(message.getPayload()));
    } else if (topic.startsWith("/values/basic")) {
      c.addValueBasic(new String(message.getPayload()));
    } else {
