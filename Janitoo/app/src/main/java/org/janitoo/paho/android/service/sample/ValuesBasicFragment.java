 ...
 *
 */
public class ValuesBasicFragment extends ListFragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    return LayoutInflater.from(getActivity()).inflate(R.layout.activity_values_basic, null);
  ...
  */
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Spanned[] history = connection.history_values_basic();
  ...
  public void refresh() {
    if (arrayAdapter != null) {
      arrayAdapter.clear();
      arrayAdapter.addAll(Connections.getInstance(getActivity()).getConnection(clientHandle).history_values_basic());
