...
public class ConnectionDetails extends FragmentActivity implements
    ...
    if (connected) {
      ...
      switch (selected) {
        ...
        case 2 : // publish view
          ...
          break;
        case 3 : // User view
          menuID = R.menu.activity_values_user;
          break;
        case 4 : // User view
          menuID = R.menu.activity_values_basic;
          break;
        default :
          menuID = R.menu.activity_connection_details;
          break;
      ...
      switch (selected) {
        ...
        case 2 : // publish view
          ...
          break;
        case 3 : // User view
          menuID = R.menu.activity_values_user_disconnected;
          break;
        case 4 : // User view
          menuID = R.menu.activity_values_basic_disconnected;
          break;
        default :
          menuID = R.menu.activity_connection_details_disconnected;
          break;
  ...
  public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public SectionsPagerAdapter(FragmentManager fragmentManager) {
      ...
      Fragment fragmentu = new ValuesUserFragment();
      Bundle argsu = new Bundle();
      argsu.putString("handle", getIntent().getStringExtra("handle"));
      fragmentu.setArguments(argsu);
      // add all the fragments for the display to the fragments list
      fragments.add(fragmentu);
      Fragment fragmentb = new ValuesBasicFragment();
      Bundle argsb = new Bundle();
      argsb.putString("handle", getIntent().getStringExtra("handle"));
    ...
    public CharSequence getPageTitle(int position) {
      switch (position) {
        ...
        case 3 :
          return getString(R.string.title_activity_values_user).toUpperCase();
        case 4 :
          return getString(R.string.title_activity_values_basic).toUpperCase();
      }
      ...
      connectionDetails.runOnUiThread(new Runnable() {
        ...
        public void run() {
          ...
          ((HistoryFragment) connectionDetails.sectionsPagerAdapter
              .getItem(0)).refresh();
          ((ValuesUserFragment) connectionDetails.sectionsPagerAdapter
              .getItem(3)).refresh();
          ((ValuesBasicFragment) connectionDetails.sectionsPagerAdapter
              .getItem(4)).refresh();
