...
public class ActivityConstants {
  ...
  static final String TAG = "Janitoo";
  ...
  static final int historyMaxEntries = 100;
  static final String historyProperty = "history";
  static final String history_values_userProperty = "history_values_user";
  static final String history_values_basicProperty = "history_values_basic";
